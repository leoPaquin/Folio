...
export default function ComptesPage() {
  ...
  function add(e: FormEvent<HTMLFormElement>) {
    ...
    const account: Account = { id: uid(), name: String(fields.name).trim(), provider: String(fields.provider), currency: fields.currency as Currency };
    ...
    if (commit({ ...state, accounts: [...state.accounts, account] })) { notify('Compte ajouté. Importez maintenant vos placements.'); router.push('/importations'); }
  }
  function remove() {
    if (!removing) return;
